    ...
    const handleSearch = () => {
        ...
        if(search || location || Course){
            filteredResults = universities.filter(university =>
                ...
                university.courses.toLowerCase().split(',').some(course => course.toLowerCase().includes(Course.toLowerCase()))
            );
            ...
            <ul>
                ...
                <li key={university.id}>
                    ...
                    <div style={{display:'flex',justifyContent:'space-between'}}>
                        <div  style={{textDecoration:'none',color:'black',fontSize:'180%',paddingTop:'5%',display:'flex',justifyContent:'space-between'}}>
                            <a>
